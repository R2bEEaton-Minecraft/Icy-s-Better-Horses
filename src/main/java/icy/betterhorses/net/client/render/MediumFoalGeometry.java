...
public final class MediumFoalGeometry {

    public static final int TEXTURE_WIDTH = 64;
    public static final int TEXTURE_HEIGHT = 64;

    private MediumFoalGeometry() {}
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition p_head2 = p_neck2.addOrReplaceChild(
                ...
                CubeListBuilder.create()
                        ...
                        .texOffs(16, 28).addBox(-1.0F, -4.5000F, -1.5000F, 2.0F, 2.0F, 4.0F, new CubeDeformation(-0.0010F)),
        ...
        PartDefinition p_left_ear2 = p_head2.addOrReplaceChild(
                "left_ear2",
                CubeListBuilder.create()
                        .texOffs(8, 37).addBox(-0.2500F, -2.0F, -1.0F, 1.0F, 2.0F, 1.0F),
                PartPose.offset(1.0F, -3.5000F, 2.5000F));

        PartDefinition p_right_ear2 = p_head2.addOrReplaceChild(
                "right_ear2",
                CubeListBuilder.create()
                        .texOffs(12, 37).addBox(-0.7500F, -2.0F, -1.0F, 1.0F, 2.0F, 1.0F),
                PartPose.offset(-1.0F, -3.5000F, 2.5000F));
        ...
        PartDefinition p_mane3 = p_head2.addOrReplaceChild(
                ...
                CubeListBuilder.create()
                        ...
                        .texOffs(34, 24).addBox(-0.0F, -3.0F, 1.0F, 0.0F, 2.0F, 2.0F),
                PartPose.offset(0.0F, -1.5000F, 2.5000F));
        ...
        PartDefinition p_mane2 = p_neck2.addOrReplaceChild(
                ...
                CubeListBuilder.create()
                        ...
                        .texOffs(4, 37).addBox(-0.0F, -7.0F, 0.5000F, 0.0F, 6.0F, 2.0F),
