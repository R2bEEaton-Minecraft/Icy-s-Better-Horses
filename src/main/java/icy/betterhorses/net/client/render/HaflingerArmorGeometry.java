...
public final class HaflingerArmorGeometry {

    public static final int TEXTURE_WIDTH = 128;
    public static final int TEXTURE_HEIGHT = 128;

    private HaflingerArmorGeometry() {}
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition p_body = root.addOrReplaceChild(
                ...
                CubeListBuilder.create()
                        .texOffs(9, 7).addBox(-5.0F, -5.0F, -11.0F, 10.0F, 9.0F, 18.0F, new CubeDeformation(0.1000F)),
        ...
        PartDefinition p_neck3 = p_neck2.addOrReplaceChild(
                "neck3",
                CubeListBuilder.create()
                        .texOffs(11, 77).addBox(-2.0F, -9.0F, -3.0F, 4.0F, 12.0F, 6.0F, new CubeDeformation(0.0990F)),
                PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition p_head2 = p_neck2.addOrReplaceChild(
                "head2",
                CubeListBuilder.create()
                        .texOffs(69, 65).addBox(-2.5000F, -5.0F, -4.0F, 5.0F, 5.0F, 7.0F, new CubeDeformation(0.1000F)),
                PartPose.offset(0.0F, -6.0F, -1.0F));

        PartDefinition p_snout2 = p_head2.addOrReplaceChild(
                "snout2",
                CubeListBuilder.create()
                        .texOffs(101, 65).addBox(-1.5000F, -1.0F, -5.0F, 3.0F, 4.0F, 6.0F, new CubeDeformation(0.0600F)),
        ...
        PartDefinition p_front_right_leg = root.addOrReplaceChild(
                "front_right_leg",
                CubeListBuilder.create()
                        .mirror().texOffs(62, 80).addBox(-2.0F, -11.0F, -2.0F, 4.0F, 9.0F, 4.0F, new CubeDeformation(0.0800F)),
                PartPose.offset(-3.0F, 23.0F, -8.9000F));

        PartDefinition p_front_left_leg = root.addOrReplaceChild(
                "front_left_leg",
                CubeListBuilder.create()
                        .texOffs(62, 80).addBox(-2.0F, -11.0F, -2.0F, 4.0F, 9.0F, 4.0F, new CubeDeformation(0.0800F)),
                PartPose.offset(3.0F, 23.0F, -8.9000F));
