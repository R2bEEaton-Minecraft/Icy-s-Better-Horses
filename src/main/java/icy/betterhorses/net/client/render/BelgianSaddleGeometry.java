...
public final class BelgianSaddleGeometry {

    public static final int TEXTURE_WIDTH = 128;
    public static final int TEXTURE_HEIGHT = 128;

    private BelgianSaddleGeometry() {}
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition p_saddle2 = p_body.addOrReplaceChild(
                "saddle2",
                CubeListBuilder.create()
                        .texOffs(59, 86).addBox(-6.5000F, -6.0F, -8.0F, 13.0F, 12.0F, 20.0F, new CubeDeformation(0.3000F)),
                PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition p_left_saddle = p_saddle2.addOrReplaceChild(
                "left_saddle",
                CubeListBuilder.create(),
                PartPose.offset(6.5000F, 0.0F, -1.0F));
        ...
        PartDefinition p_head2 = p_neck2.addOrReplaceChild(
                "head2",
                CubeListBuilder.create()
                        .texOffs(0, 78).addBox(-3.5000F, -7.0F, -4.0F, 7.0F, 7.0F, 8.0F, new CubeDeformation(0.1000F)),
        ...
        PartDefinition p_left_saddle_line_rot = p_left_rein3.addOrReplaceChild(
                ...
                PartPose.offsetAndRotation(-0.5000F, 1.5000F, 0.5000F, -0.0F, 0.3054F, 0.0F));
