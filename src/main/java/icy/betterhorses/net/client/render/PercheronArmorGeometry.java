...
public final class PercheronArmorGeometry {

    public static final int TEXTURE_WIDTH = 128;
    public static final int TEXTURE_HEIGHT = 128;

    private PercheronArmorGeometry() {}
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition p_body = root.addOrReplaceChild(
                ...
                CubeListBuilder.create()
                        .texOffs(2, 2).addBox(-6.0F, -6.0F, -12.0F, 12.0F, 11.0F, 24.0F, new CubeDeformation(0.0600F)),
        ...
        PartDefinition p_neck3 = p_neck2.addOrReplaceChild(
                "neck3",
                CubeListBuilder.create()
                        .texOffs(2, 39).addBox(-2.5000F, -12.0F, -4.0F, 5.0F, 14.0F, 8.0F, new CubeDeformation(0.0490F)),
                PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition p_head2 = p_neck2.addOrReplaceChild(
                "head2",
                CubeListBuilder.create()
                        .texOffs(76, 2).addBox(-3.0F, -7.0F, -4.0F, 6.0F, 7.0F, 8.0F, new CubeDeformation(0.0500F)),
                PartPose.offset(0.0F, -8.0F, -2.0F));

        PartDefinition p_snout2 = p_head2.addOrReplaceChild(
                "snout2",
                CubeListBuilder.create()
                        .texOffs(30, 39).addBox(-2.0F, -1.0F, -6.0F, 4.0F, 7.0F, 7.0F, new CubeDeformation(0.0600F)),
        ...
        PartDefinition p_front_right_leg = root.addOrReplaceChild(
                "front_right_leg",
                CubeListBuilder.create()
                        .texOffs(54, 39).addBox(-2.5000F, -17.0F, -2.5000F, 5.0F, 11.0F, 5.0F, new CubeDeformation(0.1700F)),
