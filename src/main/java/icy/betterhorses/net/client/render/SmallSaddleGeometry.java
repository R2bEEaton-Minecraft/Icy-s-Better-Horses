...
/**
 * Geometry for the Small horse's saddle.
 *
 * <p>GENERATED from
 * {@code blockbench/horses/SMALL/s saddle.bbmodel}
 ...
 */
public final class SmallSaddleGeometry {

    public static final int TEXTURE_WIDTH = 64;
    public static final int TEXTURE_HEIGHT = 64;

    private SmallSaddleGeometry() {}
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition p_saddle2 = p_body.addOrReplaceChild(
                "saddle2",
                CubeListBuilder.create()
                        .texOffs(9, 4).addBox(-4.0F, -5.0F, -3.0F, 8.0F, 10.0F, 8.0F, new CubeDeformation(0.3000F)),
