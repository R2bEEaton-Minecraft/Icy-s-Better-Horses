...
public final class BelgianHorseGeometry {

    public static final int TEXTURE_WIDTH = 128;
    public static final int TEXTURE_HEIGHT = 128;

    private BelgianHorseGeometry() {}
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition p_body = root.addOrReplaceChild(
                ...
                CubeListBuilder.create()
                        .texOffs(0, 0).addBox(-6.5000F, -6.0F, -12.0F, 13.0F, 12.0F, 24.0F, new CubeDeformation(0.0100F)),
        ...
        PartDefinition p_head2 = p_neck2.addOrReplaceChild(
                "head2",
                CubeListBuilder.create()
                        .texOffs(94, 20).addBox(-3.5000F, -7.0F, -4.0F, 7.0F, 7.0F, 8.0F)
        ...
        PartDefinition p_front_right_leg = root.addOrReplaceChild(
                ...
                CubeListBuilder.create()
                        ...
                        .texOffs(27, 92).addBox(-2.5000F, -10.0F, -2.5000F, 5.0F, 11.0F, 5.0F, new CubeDeformation(0.1000F))
                        .texOffs(88, 118).addBox(-2.5000F, -6.0F, 2.4000F, 0.0F, 7.0F, 3.0F, new CubeDeformation(0.0900F))
                        .texOffs(88, 118).addBox(1.5000F, -6.0F, 2.4000F, 0.0F, 7.0F, 3.0F, new CubeDeformation(0.0900F)),
        ...
        PartDefinition p_front_left_leg = root.addOrReplaceChild(
                ...
                CubeListBuilder.create()
                        ...
                        .texOffs(27, 92).addBox(-2.5000F, -10.0F, -2.5000F, 5.0F, 11.0F, 5.0F, new CubeDeformation(0.1000F))
                        .texOffs(88, 118).addBox(2.5000F, -6.0F, 2.6000F, 0.0F, 7.0F, 3.0F, new CubeDeformation(0.0900F))
                        .texOffs(88, 118).addBox(-2.5000F, -6.0F, 2.4000F, 0.0F, 7.0F, 3.0F, new CubeDeformation(0.0900F)),
                PartPose.offset(4.0F, 23.0F, -8.4000F));
        ...
        PartDefinition p_back_right_leg = root.addOrReplaceChild(
                ...
                CubeListBuilder.create()
                        ...
                        .texOffs(27, 92).addBox(-2.5000F, -10.0F, -2.5000F, 5.0F, 11.0F, 5.0F, new CubeDeformation(0.1000F))
                        .texOffs(88, 118).addBox(2.5000F, -6.0F, 2.7000F, 0.0F, 7.0F, 3.0F, new CubeDeformation(0.0900F))
                        .texOffs(88, 118).addBox(-2.5000F, -6.0F, 2.7000F, 0.0F, 7.0F, 3.0F, new CubeDeformation(0.0900F)),
                PartPose.offset(-4.0F, 23.0F, 11.5000F));
