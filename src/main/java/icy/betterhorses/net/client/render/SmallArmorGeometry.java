...
/**
 * Geometry for the Small horse's armor.
 *
 * <p>GENERATED from
 * {@code blockbench/horses/SMALL/Armor s.bbmodel}
 ...
 */
public final class SmallArmorGeometry {

    public static final int TEXTURE_WIDTH = 128;
    public static final int TEXTURE_HEIGHT = 128;

    private SmallArmorGeometry() {}
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition p_body = root.addOrReplaceChild(
                ...
                CubeListBuilder.create()
                        .texOffs(9, 7).addBox(-4.0F, -5.0F, -11.0F, 8.0F, 9.0F, 20.0F, new CubeDeformation(0.1000F)),
        ...
        PartDefinition p_neck3 = p_neck2.addOrReplaceChild(
                "neck3",
                CubeListBuilder.create()
                        .texOffs(11, 76).addBox(-2.0F, -11.0F, -4.0F, 4.0F, 14.0F, 7.0F, new CubeDeformation(0.1000F)),
        ...
        PartDefinition p_front_right_leg = root.addOrReplaceChild(
                "front_right_leg",
                CubeListBuilder.create()
                        .mirror().texOffs(62, 80).addBox(-1.5000F, -12.0F, -1.5000F, 3.0F, 9.0F, 3.0F, new CubeDeformation(0.0800F)),
                PartPose.offset(-2.5000F, 23.0F, -9.4000F));

        PartDefinition p_front_left_leg = root.addOrReplaceChild(
                "front_left_leg",
                CubeListBuilder.create()
                        .texOffs(62, 80).addBox(-1.5000F, -12.0F, -1.5000F, 3.0F, 9.0F, 3.0F, new CubeDeformation(0.0800F)),
                PartPose.offset(2.5000F, 23.0F, -9.4000F));
