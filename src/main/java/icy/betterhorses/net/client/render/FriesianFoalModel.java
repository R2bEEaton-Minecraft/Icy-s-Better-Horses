...
public class FriesianFoalModel extends FriesianHorseModel {

    private static final float STRIDE = 0.55F;

    private static final float FRONT_HOLD = 0.50F;
    private static final float BACK_HOLD = 0.30F;

    private static final float FRONT_REACH = 0.35F;
    private static final float BACK_REACH = 0.70F;

    public FriesianFoalModel(ModelPart root) {
        super(root);
    }
