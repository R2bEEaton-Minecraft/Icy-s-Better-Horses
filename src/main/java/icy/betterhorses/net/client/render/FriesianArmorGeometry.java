...
public final class FriesianArmorGeometry {

    public static final int TEXTURE_WIDTH = 128;
    public static final int TEXTURE_HEIGHT = 128;

    private FriesianArmorGeometry() {}
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition p_front_right_leg = root.addOrReplaceChild(
                "front_right_leg",
                CubeListBuilder.create()
                        .mirror().texOffs(62, 80).addBox(-2.0F, -14.0F, -2.0F, 4.0F, 9.0F, 4.0F, new CubeDeformation(0.0800F)),
                PartPose.offset(-3.0F, 23.0F, -8.9000F));

        PartDefinition p_front_left_leg = root.addOrReplaceChild(
                "front_left_leg",
                CubeListBuilder.create()
                        .texOffs(62, 80).addBox(-2.0F, -14.0F, -2.0F, 4.0F, 9.0F, 4.0F, new CubeDeformation(0.0800F)),
                PartPose.offset(3.0F, 23.0F, -8.9000F));
