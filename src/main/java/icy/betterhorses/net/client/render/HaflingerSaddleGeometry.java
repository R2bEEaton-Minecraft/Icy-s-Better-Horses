...
public final class HaflingerSaddleGeometry {

    public static final int TEXTURE_WIDTH = 64;
    public static final int TEXTURE_HEIGHT = 64;

    private HaflingerSaddleGeometry() {}
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition p_saddle2 = p_body.addOrReplaceChild(
                "saddle2",
                CubeListBuilder.create()
                        .texOffs(9, 4).addBox(-5.0F, -5.0F, -5.0F, 10.0F, 10.0F, 8.0F, new CubeDeformation(0.3000F)),
        ...
        PartDefinition p_head2 = p_neck2.addOrReplaceChild(
                "head2",
                CubeListBuilder.create()
                        .texOffs(0, 46).addBox(-2.5000F, -5.0F, -4.0F, 5.0F, 5.0F, 7.0F, new CubeDeformation(0.1500F)),
                PartPose.offset(0.0F, -6.0F, -1.0F));

        PartDefinition p_snout2 = p_head2.addOrReplaceChild(
                "snout2",
                CubeListBuilder.create()
                        .texOffs(24, 46).addBox(-1.5000F, -1.0F, -5.0F, 3.0F, 4.0F, 5.0F, new CubeDeformation(0.1000F))
        ...
        PartDefinition p_left_saddle_line_rot = p_left_rein3.addOrReplaceChild(
                ...
                CubeListBuilder.create()
                        .texOffs(0, 27).addBox(0.5000F, 0.5000F, 0.5000F, 0.0F, 3.0F, 16.0F),
        ...
        PartDefinition p_right_saddle_line_rot = p_right_rein3.addOrReplaceChild(
                ...
                CubeListBuilder.create()
                        .texOffs(32, 27).addBox(-0.5000F, 0.5000F, 0.5000F, 0.0F, 3.0F, 16.0F),
                PartPose.offsetAndRotation(0.5000F, -0.5000F, -0.5000F, -0.0F, -0.2182F, 0.0F));
