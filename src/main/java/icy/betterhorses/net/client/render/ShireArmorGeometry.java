    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition p_body = root.addOrReplaceChild(
                ...
                CubeListBuilder.create()
                        .texOffs(2, 2).addBox(-6.0F, -6.0F, -12.0F, 12.0F, 11.0F, 24.0F, new CubeDeformation(0.0500F)),
        ...
        PartDefinition p_front_right_leg = root.addOrReplaceChild(
                "front_right_leg",
                CubeListBuilder.create()
                        .texOffs(54, 39).addBox(-2.5000F, -18.0F, -2.5000F, 5.0F, 9.0F, 5.0F, new CubeDeformation(0.1700F)),
